...
export const MEMBERS: Member[] = [
  { id: 1, name: '곽주현', hue: 25, c: 0.19, l: 68 },
  { id: 2, name: '권보성', hue: 55, c: 0.17, l: 72 },
  { id: 3, name: '조연지', hue: 60, c: 0.12, l: 80 },
  { id: 4, name: '백서진', hue: 85, c: 0.17, l: 70 },
  { id: 5, name: '홍해수', hue: 95, c: 0.11, l: 85 },
  { id: 6, name: '김소정', hue: 115, c: 0.13, l: 78 },
  { id: 7, name: '박은우', hue: 145, c: 0.16, l: 65 },
  { id: 8, name: '왕수빈', hue: 165, c: 0.11, l: 80 },
  { id: 9, name: '임경빈', hue: 220, c: 0.13, l: 75 },
  { id: 10, name: '김예은', hue: 250, c: 0.02, l: 70 },
  { id: 11, name: '김진교', hue: 250, c: 0.17, l: 60 },
  { id: 12, name: '송시원', hue: 300, c: 0.13, l: 78 },
  { id: 13, name: '최수아', hue: 350, c: 0.13, l: 80 },
];
